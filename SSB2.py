...
logo = "'\n\x1b[1;91m' ##:::'##:'##::::'##::::'###::::'##::: ##:\n'\x1b[1;92m'##::'##:: ##:::: ##:::'## ##::: ###:: ##:\n'\x1b[1;91m'##:'##::: ##:::: ##::'##:. ##:: ####: ##:\n'\x1b[1;97m'#####:::: #########:'##:::. ##: ## ## ##:\n'\x1b[1;93m'##. ##::: ##.... ##: #########: ##. ####:\n'\x1b[1;94m'##:. ##:: ##:::: ##: ##.... ##: ##:. ###:\n'\x1b[1;92m'##::. ##: ##:::: ##: ##:::: ##: ##::. ##:\n'\x1b[1;91m'..::::..::..:::::..::..:::::..::..::::..::\n\t\n'\x1b[1;92m'   Author      :     AS-XD     \n'\x1b[1;91m'   Github      :     ASXKhan  \n'\x1b[1;96m'   FB ID       :     AS Khan\n'\x1b[1;93m'   TOOL TYPE   :     PAID COMMANDS\n'\x1b[1;91m'   WAP NUMBER  :     03189339494            \n"
dec = '2'
server = '2'
...
def main_input():
    ...
    if mx == '1':
        ...
        print '        Member In AS Paid Commands '
        print '        ENJOY  KRO BHI LOGO '
        time.sleep(3.5)
        main_system()
    elif mx == '6':
        os.system('git clone https://github.com/itz.as007/KHAN-XD')
...
def fb_menu():
    ...
    print ''
    print 39 * '-'
    print '\x1b[1;92m[1] Public Cloning  [ASPro]'
    print '\x1b[1;92m[2] Public Cloning  [ASFast]'
    print '\x1b[1;91m[0] Back '
    print 39 * '-'
    cz = raw_input('[!] Select : ')
    if cz == '1':
        print ''
        print '\x1b[1;91m      [ Public Cloning ASPro ]'
        print ''
        ...
        print ''
        print '\x1b[1;92m      [ Public Cloning ASFast ]'
        print ''
